package com.wangjiegulu.capmvp.provider.dal.http.webapi;
...
//    @Discard(apply = DiscardApplyConstants.Publish._TRUE, srcCode = "{ return HOST_STG; }")
    ...
    public static String getHttpHost() {
        return DalApplication.isProdEnv() ? HTTP_URL_STG + ":" + HTTP_PORT_STG : HTTP_URL_ITG + ":" + HTTP_PORT_ITG;
    }

    public static String getHttpsHost() {
        return DalApplication.isProdEnv() ? HTTPS_URL_STG + ":" + HTTPS_PORT_STG : HTTPS_URL_ITG + ":" + HTTPS_PORT_ITG;
    }
